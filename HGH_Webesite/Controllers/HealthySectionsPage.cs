...
{
    public class HealthySectionsPage : Controller
    {
        private readonly HGH_WebesiteContext _context;

        public HealthySectionsPage(HGH_WebesiteContext context)
        {
            _context = context;
        }
        ...
        // GET: E_HealthyPage/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: E_HealthyPage/Create
