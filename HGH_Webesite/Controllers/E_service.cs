...
{
    public class E_service : Controller
    {
        private readonly HGH_WebesiteContext _context;

        public E_service(HGH_WebesiteContext context)
        {
            _context = context;
        }
        ...
        // GET: E_service/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: E_service/Create
